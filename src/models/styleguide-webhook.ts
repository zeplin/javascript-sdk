...
export const transformStyleguideWebhookToJSON = function (value: StyleguideWebhook): any {
    return {
        id: value.id,
        url: value.url,
        name: value.name,
...
export const transformJSONToStyleguideWebhook = function (value: any): StyleguideWebhook {
    return {
        id: value.id,
        url: value.url,
        name: value.name,
 ...
 * 
 * @export
 * @interface StyleguideWebhook
 */
export interface StyleguideWebhook {
    /**
     * The unique id of the webhook
     * @type {string}
     * @memberof StyleguideWebhook
     */
    id: string;
    /**
